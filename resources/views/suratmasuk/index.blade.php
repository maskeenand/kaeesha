        ...
        <div class="table-responsive p-2">
          <table class="table align-items-center mb-0">
            ...
            @endphp
              ...
              <td>{{$dp->keterangan}}</td>
              <td>
                <a href="file/Masuk/{{ $dp->file_surat }}"><button class="btn btn-success" type="button">Download</button></a>
                {{-- {{$dp->file_surat}} --}}
                </td>


                    <td>
                        <a href="/suratmasuk/{{ $dp->id }}/edit" class="btn btn-warning" >Edit</a>
                    </td>
                    <td>
                        <form onsubmit="return deleteData('{{ $dp->no_surat }}')" style="display: inline" action="/suratmasuk/{{ $dp->id }}" method="POST" id="delete">
                            @method("DELETE")
                            @csrf
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold text-primary" id="exampleModalLabel">Tambah Data Surat Masuk</h4>
