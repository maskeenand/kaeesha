    ...
    <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body px-4 pt-0 pb-2">
            ...
            @endif
            <form method="POST" action="/suratkeluar/{{$dp->id}}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="txtdari" class="col-sm-2 col-form-label">Kepada</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-control-sm @error('txtkepada') is-invalid @enderror" id="txtkepada" name="txtkepada" value="{{ $dp->kepada }}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                      <input type="file" class="form-control" id="doc" name="doc" value="{{ $dp->file_surat}}">
